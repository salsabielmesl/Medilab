<nav class="navbar navbar-expand sticky-top px-4 py-0" style="background-color: #818CF8;">
    ...
    <div class="navbar-nav align-items-center ms-auto">
        <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle text-dark" data-bs-toggle="dropdown" role="button" aria-expanded="false">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm rounded-3 mt-2">
                ...
                <li>
                    <a class="dropdown-item fw-medium text-danger" href="adminlogout.php">
